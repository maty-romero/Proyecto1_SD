...
class RegistroNodos:
    ...
    def registrar_nodo(self):
        ip_cliente = Pyro5.api.current_context.client_sock_addr[0]
        print(f"[Servidor Lógico] Registrando nodo desde: {ip_cliente}")
        self.nodos_conectados.add(ip_cliente)
        return f"Nodo con IP {ip_cliente} registrado."
...
if __name__ == "__main__":
    ...
    objeto_registro_singleton = RegistroNodos()
    uri = daemon.register(objeto_registro_singleton, objectId="registro_nodos")
